...
import { createNbtBuffer, buildChunkStructureFromBlocks } from './structure-converter.js';
  ...
  let totalProcessed = 0;
    ...
    for (let chunkZ = 0; chunkZ < chunksZ; chunkZ++) {
      for (let chunkX = 0; chunkX < chunksX; chunkX++) {
        ...
        const structureData = buildChunkStructureFromBlocks(schem, getKeyAt, chunkBounds, { chunkSize: CHUNK_SIZE });
        ...
        if (structureData) {
          ...
          const chunkHasBarriers = structureData.size[1] > CHUNK_SIZE;
